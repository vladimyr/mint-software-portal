...
},{"../lib/api.js":11,"./packageGrid.html":7,"vue":106}],3:[function(require,module,exports){
'use strict';
...
},{"../lib/api.js":11,"./avatar.html":5,"./package.html":6,"lodash/assign":28,"vue":106}],4:[function(require,module,exports){
'use strict';
...
},{"../lib/api.js":11,"./search.html":8,"./searchResult.html":9,"autocomplete.js":12,"lodash/template":73,"lodash/templateSettings":74,"vue":106}],5:[function(require,module,exports){
module.exports = '<img v-if="url" class="avatar" :src="url" alt="{{ username }}\'s avatar">\n<div class="avatar default" v-else>\n    {{ username[0] | uppercase }}\n</div>\n';
},{}],6:[function(require,module,exports){
module.exports = '<div class="col-sm-6 col-sm-offset-3">\n    <h1>{{ $route.params.name }}</h1>\n    <img :src="icon">\n    <span>Score: {{ score }}</span>\n    <span>Reviews: {{ reviewsCount }}</span>\n    <span v-if="website">Website: <a :href="website">{{ website }}</a></span>\n    <span>Size: {{ size }}</span>\n\n    <div class="screenshots" v-for="screenshot in screenshots">\n        <a :href="screenshot.image"><img :src="screenshot.thumbnail"></a>\n    </div>\n\n    <ul class="categories" v-for="category in categories">\n        <li><a :href="category.link">{{ category.name }}</a></li>\n    </ul>\n\n    <ul class="releases" v-for="release in releases">\n        <li><a :href="release.link">{{ release.name }}</a></li>\n    </ul>\n\n    <div class="description">\n        <h2>{{ description.title }}</h2>\n        <p>{{{ description.content }}}</p>\n    </div>\n\n    <ul v-if="reviews" class="reviews" v-for="review in reviews">\n        <li class="review">\n            <div>\n                <a :href="review.creator.profile">\n                    <avatar-view :username="review.creator.name" :url="review.creator.avatar"></avatar-view>\n                </a>\n                <span class="name"><a :href="review.creator.profile">{{ review.creator.name }}</a></span>\n            </div>\n            <div>{{ review.created }}</div>\n            <div>{{ review.rating }}</div>\n            <p>{{{ review.content }}}</p>\n        </li>\n    </ul>\n</div>\n';
},{}],7:[function(require,module,exports){
module.exports = '<div class="pkg-grid">\n    <ul v-show="packages" class="pkg-row" v-for="packageRow in packageTable">\n        <!-- package item -->\n        <li class="pkg-item" v-for="package in packageRow">\n            <div>{{ package.score }}</div>\n            <div><a v-link="{ name: \'package\', params: { name: package.name }}">{{ package.name }}</a></div>\n            <div>{{ package.desc }}</div>\n        </li>\n    </ul>\n\n    <a v-if="page > 1" v-link="{ name: action, query: { q: query, page: page - 1 }}">Previous page</a>\n    <a v-link="{ name: action, query: { q: query, page: page + 1 }}">Next page</a>\n</div>\n';
},{}],8:[function(require,module,exports){
module.exports = '<div class="search-box">\n    <label for="search">Search:</label>\n    <input name="search" class="search" type="text" placeholder="find software...">\n</div>\n';
...
},{"./components/PackageGridView.js":2,"./components/PackageView.js":3,"./components/SearchBox.js":4,"vue":106,"vue-resource":94,"vue-router":105}],11:[function(require,module,exports){
'use strict';
...
},{"pinkie-promise":78,"url-join":80,"vue":106}],12:[function(require,module,exports){
'use strict';

module.exports = require('./src/standalone/');

},{"./src/standalone/":27}],13:[function(require,module,exports){
...
},{"../common/utils.js":23}],15:[function(require,module,exports){
'use strict';
...
},{"../common/dom.js":22,"../common/utils.js":23,"./css.js":14,"./event_emitter.js":18,"./html.js":19}],16:[function(require,module,exports){
'use strict';
...
},{"../common/dom.js":22,"../common/utils.js":23,"./css.js":14,"./dataset.js":15,"./event_emitter.js":18}],17:[function(require,module,exports){
'use strict';
...
},{"../common/dom.js":22,"../common/utils.js":23}],18:[function(require,module,exports){
'use strict';
...
},{"../common/dom.js":22,"../common/utils.js":23,"./event_emitter.js":18}],21:[function(require,module,exports){
'use strict';
...
},{"../common/dom.js":22,"../common/utils.js":23,"../sources/index.js":25,"./css.js":14,"./dropdown.js":16,"./event_bus.js":17,"./html.js":19,"./input.js":20}],22:[function(require,module,exports){
'use strict';
...
},{"./dom.js":22}],24:[function(require,module,exports){
'use strict';
...
},{"../common/utils.js":23}],25:[function(require,module,exports){
'use strict';
...
},{"./hits.js":24,"./popularIn.js":26}],26:[function(require,module,exports){
'use strict';
...
},{"../common/utils.js":23}],27:[function(require,module,exports){
'use strict';
...
},{"../autocomplete/event_bus.js":17,"../autocomplete/typeahead.js":21,"../common/dom.js":22,"../common/utils.js":23,"npm-zepto":13}],28:[function(require,module,exports){
...
},{"./internal/copyObject":45,"./internal/createAssigner":47,"./keys":70}],29:[function(require,module,exports){
...
},{"./internal/copyObjectWith":46,"./internal/createAssigner":47,"./keysIn":71}],30:[function(require,module,exports){
...
},{"./internal/apply":35,"./isError":63,"./rest":72}],31:[function(require,module,exports){
/**
...
},{"./internal/escapeHtmlChar":48,"./toString":77}],33:[function(require,module,exports){
(function (global){
...
},{"../eq":31}],38:[function(require,module,exports){
(function (global){
var eq = require('../eq');
...
},{"../eq":31}],39:[function(require,module,exports){
(function (global){
/** Used for built-in method references. */
var objectProto = global.Object.prototype;
...
},{"./Reflect":33,"./iteratorToArray":55}],42:[function(require,module,exports){
/**
...
},{"./arrayMap":36}],45:[function(require,module,exports){
...
},{"./copyObjectWith":46}],46:[function(require,module,exports){
...
},{"./assignValue":38}],47:[function(require,module,exports){
...
},{"../rest":72,"./isIterateeCall":53}],48:[function(require,module,exports){
...
},{"./baseProperty":42}],51:[function(require,module,exports){
...
},{"../isArguments":59,"../isArray":60,"../isLength":65,"../isString":68,"./baseTimes":43}],52:[function(require,module,exports){
...
},{"../eq":31,"../isArrayLike":61,"../isObject":66,"./isIndex":52}],54:[function(require,module,exports){
(function (global){
/** Used for built-in method references. */
var objectProto = global.Object.prototype;
...
},{"./isArrayLikeObject":62}],60:[function(require,module,exports){
/**
...
},{"./internal/getLength":50,"./isFunction":64,"./isLength":65}],62:[function(require,module,exports){
...
},{"./isArrayLike":61,"./isObjectLike":67}],63:[function(require,module,exports){
(function (global){
...
},{"./isObjectLike":67}],64:[function(require,module,exports){
(function (global){
...
},{"./isArray":60,"./isObjectLike":67}],69:[function(require,module,exports){
(function (global){
var isObjectLike = require('./isObjectLike');
...
},{"./isObjectLike":67}],70:[function(require,module,exports){
...
},{"./internal/baseHas":39,"./internal/baseKeys":40,"./internal/indexKeys":51,"./internal/isIndex":52,"./internal/isPrototype":54,"./isArrayLike":61}],71:[function(require,module,exports){
(function (global){
...
},{"./internal/baseKeysIn":41,"./internal/indexKeys":51,"./internal/isIndex":52,"./internal/isPrototype":54}],72:[function(require,module,exports){
var apply = require('./internal/apply'),
...
},{"./internal/apply":35,"./toInteger":75}],73:[function(require,module,exports){
...
},{"./assignInWith":29,"./attempt":30,"./internal/assignInDefaults":37,"./internal/baseValues":44,"./internal/escapeStringChar":49,"./internal/isIterateeCall":53,"./internal/reInterpolate":58,"./isError":63,"./keys":70,"./templateSettings":74,"./toString":77}],74:[function(require,module,exports){
...
},{"./escape":32,"./internal/reEscape":56,"./internal/reEvaluate":57,"./internal/reInterpolate":58}],75:[function(require,module,exports){
...
},{"./toNumber":76}],76:[function(require,module,exports){
...
},{"./isFunction":64,"./isObject":66}],77:[function(require,module,exports){
...
},{"./internal/_Symbol":34,"./isSymbol":69}],78:[function(require,module,exports){
(function (global){
'use strict';
...
},{"pinkie":79}],79:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../../promise":97,"../../util":104,"./xhr":85}],83:[function(require,module,exports){
/**
 * JSONP client.
 */
...
},{"../../promise":97,"../../util":104}],84:[function(require,module,exports){
/**
...
},{"../../promise":97,"../../util":104}],85:[function(require,module,exports){
/**
 * XMLHttp client.
 */
...
},{"../../promise":97,"../../util":104}],86:[function(require,module,exports){
/**
 * CORS Interceptor.
 */
...
},{"../util":104,"./client/xdr":84}],87:[function(require,module,exports){
/**
 * Header Interceptor.
 */
...
},{"../util":104}],88:[function(require,module,exports){
/**
...
},{"../promise":97,"../util":104,"./before":81,"./client":82,"./cors":86,"./header":87,"./interceptor":89,"./jsonp":90,"./method":91,"./mime":92,"./timeout":93}],89:[function(require,module,exports){
/**
 * Interceptor factory.
 */
...
},{"../promise":97,"../util":104}],90:[function(require,module,exports){
/**
 * JSONP Interceptor.
 */
...
},{"./client/jsonp":83}],91:[function(require,module,exports){
/**
...
},{"./http":88,"./promise":97,"./resource":98,"./url":99,"./util":104}],95:[function(require,module,exports){
/**
...
},{"./lib/promise":95,"./util":104}],98:[function(require,module,exports){
/**
...
},{"../util":104,"./legacy":100,"./query":101,"./root":102,"./template":103}],100:[function(require,module,exports){
/**
 * Legacy Transform.
 */
...
},{"../util":104}],101:[function(require,module,exports){
/**
...
},{"../lib/url-template":96}],104:[function(require,module,exports){
/**
 * Utility functions.
 */
